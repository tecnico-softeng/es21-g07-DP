...
import ItemConnectionAnswerDetails from '@/models/management/questions/pci/ItemConnectionAnswerDetails';
import ItemConnectionStatementQuestionDetails from '@/models/statement/questions/pci/ItemConnectionStatementQuestionDetails';
import ItemConnectionStatementAnswerDetails from '@/models/statement/questions/pci/ItemConnectionStatementAnswerDetails';
...
import OpenStatementQuestionDetails from '@/models/statement/questions/OpenStatementQuestionDetails';
...
export abstract class QuestionFactory {
  static getFactory(type: string): QuestionFactory {
    switch (type) {
      ...
      case QuestionTypes.ItemConnection:
        return new ItemConnectionQuestionFactory();
...
class ItemConnectionQuestionFactory extends QuestionFactory {
  createEmptyQuestionDetails(): QuestionDetails {
    return new ItemConnectionQuestionDetails();
  }
  createQuestionDetails(details: any): QuestionDetails {
    return new ItemConnectionQuestionDetails(details);
  }
  createAnswerDetails(details: any): AnswerDetails {
    return new ItemConnectionAnswerDetails(details);
  }
  createStatementQuestionDetails(details: any): StatementQuestionDetails {
    return new ItemConnectionStatementQuestionDetails(details);
  }
  createStatementAnswerDetails(details: any): StatementAnswerDetails {
    return new ItemConnectionStatementAnswerDetails(details);
  }
  createStatementCorrectAnswerDetails(details: any): StatementCorrectAnswerDetails {
    return new ItemConnectionStatementCorrectAnswerDetails(details);
  }
...
class OpenQuestionFactory extends QuestionFactory {
  ...
  createStatementQuestionDetails(details: any): StatementQuestionDetails {
    return new OpenStatementQuestionDetails(details);
  }
  createStatementAnswerDetails(details: any): StatementAnswerDetails {
    throw new Error('not implemented');
  }
