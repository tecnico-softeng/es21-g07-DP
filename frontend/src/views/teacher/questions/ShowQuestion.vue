...
import OpenView from '@/components/open/OpenView.vue';
import ItemConnectionView from '@/components/item-connection/ItemConnectionView.vue';
...
@Component({
  components: {
    ...
    open: OpenView,
    item_connection: ItemConnectionView,
  },
})
