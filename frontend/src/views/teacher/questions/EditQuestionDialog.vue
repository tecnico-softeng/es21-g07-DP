...
import ItemConnectionCreate from '@/components/item-connection/ItemConnectionCreate.vue';
import OpenCreate from '@/components/open/OpenCreate.vue';
...
@Component({
  components: {
    ...
    item_connection: ItemConnectionCreate,
    open: OpenCreate,
  },
})
