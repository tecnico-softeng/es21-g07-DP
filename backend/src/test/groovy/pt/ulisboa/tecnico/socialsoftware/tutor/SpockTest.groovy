...
class SpockTest extends Specification {
    ...
    public static final String OPEN_QUESTION_TEACHER_ANSWER_1 = "Open Answer 1"
    public static final String OPEN_QUESTION_TEACHER_ANSWER_2 = "Open Answer 2"
    ...
    public static final String OPTION_5_CONTENT = "Option 5 Content"
    ...
    @Autowired
    ConnectionItemRepository connectionItemRepository
