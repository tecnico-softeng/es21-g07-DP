package pt.ulisboa.tecnico.socialsoftware.tutor.impexp.service.pra
...
class ImportExportOpenQuestionTest extends SpockTest {
    ...
    def 'export and import questions to xml'() {
        ...
        questionResult.getQuestionDetailsDto().getTeacherAnswer() == OPEN_QUESTION_TEACHER_ANSWER_1
    }
