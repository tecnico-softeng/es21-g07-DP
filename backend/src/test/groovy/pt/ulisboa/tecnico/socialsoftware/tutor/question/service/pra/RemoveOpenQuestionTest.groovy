...
@DataJpaTest
public class RemoveOpenQuestionTest extends SpockTest {
    def question
    ...
    def "remove an open question used in a quiz"() {
    ...
    def "remove an open question that has topics"() {
    ...
    def "remove an open question that was submitted"() {
        given: "a student"
