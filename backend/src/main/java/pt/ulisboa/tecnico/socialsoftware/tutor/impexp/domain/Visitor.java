...
public interface Visitor {
    ...
    default void visitQuestionDetails(OpenQuestion openQuestion) {}

    default void visitQuestionDetails(ItemConnectionQuestion question){}

    default void visitItem(ConnectionItem item){}

    default void visitConnectionLink(ConnectionLink link){}
