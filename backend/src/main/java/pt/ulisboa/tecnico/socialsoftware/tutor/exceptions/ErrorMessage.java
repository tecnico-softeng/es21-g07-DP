...
public enum ErrorMessage {
    ...
    INVALID_TEACHER_ANSWER("Invalid teacher answer for question"),
    ...
    AT_LEAST_THREE_OPTIONS_ORDERED("Multiple choices with order need to have at least 3 correct options ordered."),
    NOT_ALL_HAVE_ORDER("At least one correct option doesn't have order defined"),
    ONE_CORRECT_OPTION_NEEDED("Questions need to have at least 1 correct option"),
    INCORRECT_ORDER("The order is incorrect. Please check it first"),
    ...
    NO_CONNECTIONS_GIVEN("There must be at least one connection"),
    NOT_ENOUGH_OPTIONS_IN_GROUPS("One of the groups must have at least 2 option and the other 1"),
    INVALID_CONNECTIONS_GIVEN("At least one of the connections given was to an non existent item");
